...
IF(GIT_EXECUTABLE AND EXISTS "${ELOQSQL_SOURCE_DIR}/.git")
  EXECUTE_PROCESS(COMMAND "${GIT_EXECUTABLE}" config --get cmake.update-submodules
                  WORKING_DIRECTORY "${ELOQSQL_SOURCE_DIR}"
...
IF(update_result OR NOT EXISTS ${ELOQSQL_SOURCE_DIR}/libmariadb/CMakeLists.txt)
